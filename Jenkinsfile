pipeline {
  ...
  stages {
    stage("Build") {
      steps {
        configFileProvider([configFile(fileId: "fcf30dba-9aae-4f37-b7a7-c7ccb6ab9219c", variable: "MAVEN_SETTINGS_XML")]) {
    ...
    stage("Docker Build & Push") {
      ...
      steps {
        script {
          ...
          def app = docker.build("plchavez98/tds-microservice-products")
